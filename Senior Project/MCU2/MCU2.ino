...
//กำหนดตำแหน่งปลูก
    int floor1[5][2]={{0,0},{1830,0},{2670,0},{3550,0},{4365,0}};
    int floor2[5][2]={{0,3600},{860,3600},{1850,3600},{2860,3600},{3830,3600}};
    int floor3[5][2]={{0,7620},{905,7620},{1900,7620},{2880,7620},{3860,7680}};
    int effect[6]={1555,6685,600,5510,5780,300};
//Set ตำแหน่งปลูก
